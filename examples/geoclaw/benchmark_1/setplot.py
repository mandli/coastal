...
import clawpack.geoclaw.data as geoclaw_data
...
#--------------------------
    ...
    geo_data = geoclaw_data.GeoClawData()
    geo_data.read(os.path.join(os.getcwd(), 'geoclaw.data'))
    ...
    def set_drytol(current_data):
        ...
        current_data.user["drytol"] = geo_data.dry_tolerance
