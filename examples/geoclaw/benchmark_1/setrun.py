...
#------------------------------
    ...
    # Gauges:
    # ---------------
    rundata.gaugedata.gauges = [[1, 0.25, 0, 0, 120], [2, 9.95, 0, 0, 120]]
    ...
    amrdata.refinement_ratios_x = [4, 2, 4]
    ...
    # Regions:
    # ---------------
    rundata.regiondata.regions = [[2, 2, 0.0, 1000000000.0, 0, 6, 0, 1], [3, 3, 0.0, 1000000000.0, 0, 3, 0, 1]]
...
#-------------------
    ...
    # == settopo.data values ==
    rundata.topo_data.topofiles = [[2, 1, 1, 0.0, 10000000000.0, 'beach.topotype2']]
