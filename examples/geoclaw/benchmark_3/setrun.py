...
#------------------------------
    ...
    clawdata.upper[0] = 6.2          # xupper
    clawdata.lower[1] = 0          # ylower
    clawdata.upper[1] = 1.8          # yupper
    
    # Number of grid cells:
    clawdata.num_cells[0] = 144      # mx
    clawdata.num_cells[1] = 36      # my
    ...
    # Gauges:
    # ---------------
    rundata.gaugedata.gauges = [[1, 0.55993358350514111, 0.001, 0.0, 10000.0], [2, 1.469, 0.35, 0.0, 10000.0], [3, 1.929, 0.001, 0.0, 10000.0], [4, 1.929, 0.5, 0.0, 10000.0]]
    ...
    amrdata.refinement_ratios_x = [10]
    amrdata.refinement_ratios_y = [10]
    ...
    amrdata.aux_type = ['center', 'center', 'center']
    ...
    # Regions:
    # ---------------
    rundata.regiondata.regions = [[2, 2, 0.0, 20.0, -0.1, 0.1, 0, 0.1]]
...
#-------------------
    ...
    refinement_data.deep_depth = 1.0
    refinement_data.max_level_deep = 3

    # == settopo.data values ==
    rundata.topo_data.topofiles = [[1, 1, 1, 0.0, 9000000000.0, 'tank.tt1']]
